...
public class AttendanceService {
    ...
    public List<MemberAttendance> findMemberAttendanceList(Integer memberId, Integer groupId, Boolean attendance) {
    ...
    public String attendancePrint(Integer memberId, Integer groupId, Boolean attendance) {
        ...
        attendanceSearch.setGroupId(groupId);
        attendanceSearch.setAttendance(attendance);
        List<MemberAttendance> memberAttendanceList = attendanceMapper.findAttendance(attendanceSearch);
    ...
    public int attendanceCheck(List<Member> memberList) {
        ...
        try {
            ...
            for (Member member : memberList) {
                List<MemberAttendance> memberAttendanceList = attendanceMapper.findAttendance(new AttendanceSearch(member.getId()));
