package com.esc.estogether.util;

import com.esc.estogether.model.type.CodeEnum;
...
public abstract class EnumTypeHandler <E extends Enum <E>> implements TypeHandler<CodeEnum> {
